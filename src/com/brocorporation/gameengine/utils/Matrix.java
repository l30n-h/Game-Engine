...
public class Matrix {
	...
	public static void multiplyMM(float[] result, int resultOffset,
		...
		final float l12 = lhs[lhsOffset + 12];
		final float l13 = lhs[lhsOffset + 13];
		final float l14 = lhs[lhsOffset + 14];
		final float l15 = lhs[lhsOffset + 15];
		...
		final float r11 = rhs[rhsOffset + 11];
		final float r12 = rhs[rhsOffset + 12];
		final float r13 = rhs[rhsOffset + 13];
		final float r14 = rhs[rhsOffset + 14];
		final float r15 = rhs[rhsOffset + 15];
		result[resultOffset] = r0 * l0 + r1 * l4 + r2 * l8 + r3 * l12;
		result[resultOffset + 1] = r0 * l1 + r1 * l5 + r2 * l9 + r3 * l13;
		result[resultOffset + 2] = r0 * l2 + r1 * l6 + r2 * l10 + r3 * l14;
		result[resultOffset + 3] = r0 * l3 + r1 * l7 + r2 * l11 + r3 * l15;
		result[resultOffset + 4] = r4 * l0 + r5 * l4 + r6 * l8 + r7 * l12;
		result[resultOffset + 5] = r4 * l1 + r5 * l5 + r6 * l9 + r7 * l13;
		result[resultOffset + 6] = r4 * l2 + r5 * l6 + r6 * l10 + r7 * l14;
		result[resultOffset + 7] = r4 * l3 + r5 * l7 + r6 * l11 + r7 * l15;
		result[resultOffset + 8] = r8 * l0 + r9 * l4 + r10 * l8 + r11 * l12;
		result[resultOffset + 9] = r8 * l1 + r9 * l5 + r10 * l9 + r11 * l13;
		result[resultOffset + 10] = r8 * l2 + r9 * l6 + r10 * l10 + r11 * l14;
		result[resultOffset + 11] = r8 * l3 + r9 * l7 + r10 * l11 + r11 * l15;
		result[resultOffset + 12] = r12 * l0 + r13 * l4 + r14 * l8 + r15 * l12;
		result[resultOffset + 13] = r12 * l1 + r13 * l5 + r14 * l9 + r15 * l13;
		result[resultOffset + 14] = r12 * l2 + r13 * l6 + r14 * l10 + r15 * l14;
		result[resultOffset + 15] = r12 * l3 + r13 * l7 + r14 * l11 + r15 * l15;
	}
	...
	public static void multiplyVM(float[] resultVec, int resultVecOffset,
		...
		final float l0 = lhsVec[lhsVecOffset];
		final float l1 = lhsVec[lhsVecOffset + 1];
		final float l2 = lhsVec[lhsVecOffset + 2];
		final float l3 = lhsVec[lhsVecOffset + 3];
		resultVec[resultVecOffset] = rhsMat[rhsMatOffset] * l0
				+ rhsMat[rhsMatOffset + 1] * l1 + rhsMat[rhsMatOffset + 2] * l2
				+ rhsMat[rhsMatOffset + 3] * l3;
		resultVec[resultVecOffset + 1] = rhsMat[rhsMatOffset + 4] * l0
				+ rhsMat[rhsMatOffset + 5] * l1 + rhsMat[rhsMatOffset + 6] * l2
				+ rhsMat[rhsMatOffset + 7] * l3;
		resultVec[resultVecOffset + 2] = rhsMat[rhsMatOffset + 8] * l0
				+ rhsMat[rhsMatOffset + 9] * l1 + rhsMat[rhsMatOffset + 10]
				* l2 + rhsMat[rhsMatOffset + 11] * l3;
		resultVec[resultVecOffset + 3] = rhsMat[rhsMatOffset + 12] * l0
				+ rhsMat[rhsMatOffset + 13] * l1 + rhsMat[rhsMatOffset + 14]
				* l2 + rhsMat[rhsMatOffset + 15] * l3;
	}
	...
	public static void multiplyMV(float[] resultVec, int resultVecOffset,
		...
		final float r0 = rhsVec[rhsVecOffset];
		final float r1 = rhsVec[rhsVecOffset + 1];
		final float r2 = rhsVec[rhsVecOffset + 2];
		final float r3 = rhsVec[rhsVecOffset + 3];
		resultVec[resultVecOffset] = r0 * lhsMat[lhsMatOffset] + r1
				* lhsMat[lhsMatOffset + 4] + r2 * lhsMat[lhsMatOffset + 8] + r3
				* lhsMat[lhsMatOffset + 12];
		resultVec[resultVecOffset + 1] = r0 * lhsMat[lhsMatOffset + 1] + r1
				* lhsMat[lhsMatOffset + 5] + r2 * lhsMat[lhsMatOffset + 9] + r3
				* lhsMat[lhsMatOffset + 13];
		resultVec[resultVecOffset + 2] = r0 * lhsMat[lhsMatOffset + 2] + r1
				* lhsMat[lhsMatOffset + 6] + r2 * lhsMat[lhsMatOffset + 10]
				+ r3 * lhsMat[lhsMatOffset + 14];
		resultVec[resultVecOffset + 3] = r0 * lhsMat[lhsMatOffset + 3] + r1
				* lhsMat[lhsMatOffset + 7] + r2 * lhsMat[lhsMatOffset + 11]
				+ r3 * lhsMat[lhsMatOffset + 15];
	}
